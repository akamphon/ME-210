...
\begin{example}
  ...
  \centering
  \begin{tikzpicture}
    \node [draw, rectangle, pattern=north east lines, minimum height=3cm, minimum width=1.5cm](lwall){};
    ...
    \node at (bar.east) [anchor=west, draw, rectangle, pattern=north east lines, minimum height=3cm, minimum width=1.5cm](rwall){};
    \node at (bar.north west) [above right]{A};
    \node at (bar.north east) [above left]{B};
    \draw [->, line width=5pt] (bar.center) ++ (0:0.5) node[above, yshift=0.2cm]{C} --++ (180:1.5) node[left]{$P$};
  ...
  \end{tikzpicture}
  % \includegraphics[scale=0.7]{pictures/Axial-load/statically-indet}
\end{example}
\begin{solution}
...
\begin{exercises}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
      ...
      \node at (A.west) [anchor=east, draw, rectangle, minimum height=2cm, minimum width=1cm, pattern=north east lines]{};
      \node at (A.east) [anchor=west, draw, rectangle, minimum height=2cm, minimum width=1cm, pattern=north east lines]{};
    \end{tikzpicture}
  \end{figure}
...
\begin{example}
  A 40-mm diameter transmission shaft is connected to a motor whose output power is constant at 10 hp.  If the shaft needs to transfer the torque at shaft speed between 100 to 2000 rpm, what is the minimum shear stress the material should be able to withstand?
    ...
    \begin{tikzpicture}
      ...
      \node at (shaft.west)[anchor=east, draw, rectangle, fill=Grey, minimum height=2cm, minimum width=2cm](motor){Motor};
...
\begin{example}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}[>=latex]
      ...
      \node at (beam.south west)[anchor=north, xshift=1cm, draw, fill=LightGray, regular polygon, regular polygon sides=3, minimum height=5mm, inner sep=0](left){};
