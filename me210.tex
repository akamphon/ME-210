...
\begin{titlepage}
  ...
  \raggedright \includegraphics[width=0.2\textwidth]{pictures/logo-tu} \\
  \noindent
  \color{white}
...
\begin{exercises}
  ...
  \begin{marginfigure}
    ...
    \begin{tikzpicture}[rotate=90]
      ...
      \node at (1.8,-0.1) [anchor=north west, draw, fill=LightSkyBlue!40, minimum height=0.49cm, minimum width=2cm, rotate=90](right){};
      \node at (right.center) [anchor=east, draw, fill=LightGrey, minimum height=1.8cm, minimum width=4mm, rotate=90](){};
      \draw [->, ultra thick] (0,-0.3) --++ (180:1) node[below]{50 kN};
      \draw [->, ultra thick] (right.east) --++ (0:1) node[above]{50 kN};
    \end{tikzpicture}
...
\begin{example}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}[>=latex]
      ...
      % beam with load
      \node at (topcross.east) [anchor=west, xshift=2cm, draw, fill=LightSkyBlue, rectangle, minimum height=0.6cm, minimum width=7cm](top){};
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}[>=latex]
    ...
    %%%% cut section %%%%
    \draw [fill=LightBlue] (F) ++ (0:6) node(G){} --++ (-90:2.3) node(H){} --++ (0:2.3) node(I){} -- cycle node[midway](J){};
